...
const bgSound = new Audio('./1.mp3');
const eating = new Audio('./2.mp3');
const death = new Audio('./explosion-6801.mp3')
...
food.random();
setInterval(() => {
    ctx.fillRect(0, 0, 500, 340); //Pintar cuadros
    ...
    if(gameOver()){
        death.play();
        alert('Perdiste por no ser insano 😹👊');
        snake = init();
    }
